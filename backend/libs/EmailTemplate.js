...
export const Appointment_Confirmation_Email_Template = `
  <!DOCTYPE html>
  <html lang="en">
  <head>
      <meta charset="UTF-8">
  ...
  <body>
      <div class="container">
          ...
          <div class="content">
              <p>Hello {name},</p>
              <p>You have booked an appointment with <strong>Dr. {doctor}</strong> on <strong>{date}</strong>.</p>
              <p>Please confirm or cancel your appointment by clicking one of the buttons below:</p>
              <div class="button-container">
                  <a href="{confirmLink}" class="button confirm">Confirm</a>
                  <a href="{cancelLink}" class="button cancel">Cancel</a>
              </div>
              <p>If you have any questions, feel free to contact us.</p>
          </div>
          <div class="footer">
              <p>&copy; ${new Date().getFullYear()} Arogya Hospital. All rights reserved.</p>
          </div>
      </div>
  </body>
  </html>
