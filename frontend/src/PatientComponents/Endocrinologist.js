...
const Endocrinologist = ({ onBack, patientData, selectedDoctor, onComplete }) => {
    ...
    <div className="timeslot-container">
      ...
      {!shift ? (
        ...
        <>
          ...
          <h2>Selected Shift: {shift === "morning" ? "Morning (10 AM - 3 PM)" : "Evening (5 PM - 9 PM)"}</h2>
